        ...
        <div>
          ...
          <Markdown
            ...
            components={{
              ...
              plancards: (props) => {
                // The content inside the directive is in `props.children`.
                // The directive attributes are in `props` as well.
                // For an async client component, we can just render <PlanCards />:
